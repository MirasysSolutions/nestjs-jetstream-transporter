...
export class NatsStreamingTransporter
  extends Server
  ...
  private async bindEventHandlers() {
    ...
    if (!registerdPatterns) {
      ...
      registerdPatterns.forEach(async (subject) => {
        ...
        console.log(
          `Subscribed to ${subject} event with consumer ${cinfo.name} in stream ${cinfo.stream_name}`,
        );
      });
    }
  }
...
export class NatsService {
  ...
  constructor(
    ...
    this.transporter = new NatsStreamingTransporter(
